...
git clone https://github.com/nikhil-garg/STDP_MNIST.git
cd STDP_MNIST

python mnist_stdp_multiple_exploration_v10.py --log_file_path $OUTDIR

tar xf $SLURM_TMPDIR/STDP_MNIST -C $OUTDIR
